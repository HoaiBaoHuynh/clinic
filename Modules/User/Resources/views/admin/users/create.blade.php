                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('first_name', '', ['class' => 'form-control', 'placeholder' => trans('user::users.form.first-name')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('last_name', '', ['class' => 'form-control', 'placeholder' => trans('user::users.form.last-name')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::email('email', '' , ['class' => 'form-control', 'placeholder' => trans('user::users.form.email')]) !!}
